...
<div class="container-fluid">
  ...
  <div class="row">
	...
	<br>
	 <div class="row">
    <div class="col-sm-7 " id="m">Create your Account by entering your credentials</div>
	</div>
	<br>
    <form  method="POST" action="http://localhost/food/index.php/new_customer/validate">
	 <div class="row">
    <div   class="col-sm-12"><input id="op" type="text" name="sid"  style="opacity:.8;"  placeholder="Your College rollno.."></div>
  </div>
  
  <br>
 
  <div class="row">
    <div class="col-sm-12"><input id="op" type="password" name="pwd"  style="opacity:.8;"  placeholder="Your pwd."></div>
