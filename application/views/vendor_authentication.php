...
<div class="container-fluid">
  ...
  <div class="row">
	...
	<br>
	 <div class="row">
    <div class="col-sm-7 " id="m"><span style="color:red;">LOGIN</span> by entering your Credentials.</div>
	<form action="http://localhost/food/index.php/new_vendor">
	<div class="col-sm-5"><input type="submit" style=width:90% value="CREATE ACCOUNT"><br>
	
	</div>
	</form>
	</div>
	<br>
	<form method="POST" action="http://localhost/food/index.php/vendor/validate">
	 <div class="row">
    <div class="col-sm-12"><input type="text" id="fname" name="id"  style="opacity:.8;" placeholder=" Enter Your ID.."></div>
  ...
  <div class="row">
    <div class="col-sm-12"><input type="password" id="lname" name="pwd"    style="opacity:.8;"  placeholder="Enter Your password.."></div>
  ...
  <hr>
  <h5> Can't Login?</h5>
<a href="#contact">Click to contact</a><br><br>
 <hr>
