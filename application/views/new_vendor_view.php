...
<div class="container-fluid">
  ...
  <div class="row">
	...
	<br>
	<br>
	<form method="POST" action="http://localhost/food/index.php/new_vendor/validate">
	 <div class="row">
    <div class="col-sm-12"><input type="text" name="name" style="opacity:.8;"   placeholder="Your Phone no.."></div>
  ...
  <div class="row">
    <div class="col-sm-12"><input type="text" name="sname"   style="opacity:.8;" placeholder="Your shop name.."></div>
